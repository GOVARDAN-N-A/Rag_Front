...
import FindRagPickersByCity from './components/RagPickers/ragPickers';
import JoinRag from './components/JoinRag/joinRag';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='/rag' element={<FindRagPickersByCity />} />
        <Route path='join' element={<JoinRag />} />
